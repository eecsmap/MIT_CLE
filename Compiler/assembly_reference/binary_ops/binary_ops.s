...
# binary_ops.c:4:     a = b + c;
	...
	movl	%eax, -28(%rbp)	# tmp96, a
# binary_ops.c:5:     b = c - d;
	movl	-20(%rbp), %eax	# c, tmp102
	subl	-16(%rbp), %eax	# d, tmp101
	movl	%eax, -24(%rbp)	# tmp101, b
# binary_ops.c:6:     c++;
	addl	$1, -20(%rbp)	#, c
# binary_ops.c:7:     --d;
	subl	$1, -16(%rbp)	#, d
# binary_ops.c:8:     e = (f == g);
	movl	-8(%rbp), %eax	# f, tmp103
	cmpl	-4(%rbp), %eax	# g, tmp103
	sete	%al	#, _1
# binary_ops.c:8:     e = (f == g);
	movzbl	%al, %eax	# _1, tmp104
	movl	%eax, -12(%rbp)	# tmp104, e
...
.L4:
# binary_ops.c:10:     g = (e || f);
	movl	$1, %eax	#, iftmp.1_4
	jmp	.L6	#
.L5:
# binary_ops.c:10:     g = (e || f);
	movl	$0, %eax	#, iftmp.1_4
.L6:
# binary_ops.c:10:     g = (e || f);
	movl	%eax, -4(%rbp)	# iftmp.1_4, g
# binary_ops.c:11:     e = !f;
	cmpl	$0, -8(%rbp)	#, f
	sete	%al	#, _2
# binary_ops.c:11:     e = !f;
	movzbl	%al, %eax	# _2, tmp105
	movl	%eax, -12(%rbp)	# tmp105, e
# binary_ops.c:12:     e = -f;
	movl	-8(%rbp), %eax	# f, tmp109
	negl	%eax	# tmp108
	movl	%eax, -12(%rbp)	# tmp108, e
# binary_ops.c:13:     return 0;
	movl	$0, %eax	#, _25
# binary_ops.c:14: }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
